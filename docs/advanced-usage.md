...
- **Gemini Models**: Support thinking modes (minimal to max), web search, 1M context
  ...
  - **Flash 3 Preview**: Highest-ranked fast Gemini fallback for responsive tool flows
  - **Flash 2.5**: Stable fast Gemini model with thinking support
  - **Flash Lite variants**: Lower-cost text-first options when you want lighter responses
...
These only apply to models that support customizing token usage for extended thinking, such as Gemini 3.1 Pro Preview.
...
# Architecture analysis with Gemini 3.1 Pro Preview
...
**Supported Models:**
- **Gemini 3.1 Pro Preview & Flash variants**: Excellent for diagrams, architecture analysis, UI mockups (up to 20MB total)
